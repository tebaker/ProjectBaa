...
Play.prototype =
{
	...
	create: function ()
	{
		...
		player.animations.add('left', Phaser.ArrayUtils.numberArray(0,52), 30, false, true);
		//player.animations.add('right', [], 30, false, true);
		player.animations.add('jump', Phaser.ArrayUtils.numberArray(53, 91), 30, false, true);
		player.animations.add('idle', Phaser.ArrayUtils.numberArray(92, 106), 30, false, true);
		player.animations.add('hide', Phaser.ArrayUtils.numberArray(107, 116), 30, false, true);
